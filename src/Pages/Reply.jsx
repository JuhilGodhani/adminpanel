...
import Reply_under from "../components/Reply_under";
...
const Reply = () => {
  ...
  console.log("object :>> ", contactmsg?.yourName);
  const [isHide, setisHide] = useState(true);
  const [checkboxclick, setCheckboxclick] = useState("Unchecked");
  const [tab, setTab] = useState("Contact");
  const [Heading, setHeading] = useState("Reply");
  const [SubHeading, setSubHeading] = useState(contactmsg?.yourName);
          ...
          <div className="head-title">
            <div className="left">
              ...
              <ul className="breadcrumb">
                ...
                <li onClick={() => navigate("/contactdata")}>
                ...
                <li>
                  <a className="active" href="#">
                    Reply to <span className="name1">{SubHeading}</span>
                  </a>
                </li>
              </ul>
            </div>
